...
public class SaveReviewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher("/WEB-INF/jsp/user-content.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (name.equals("") || review.equals("")) {
            requestDispatcher = getServletContext().getRequestDispatcher("/WEB-INF/jsp/user-content-wrong.jsp");
            requestDispatcher.forward(req, resp);
        }
        ...
        List<Review> reviews = getReviewByMovieId(selectMovieByName.get().getId());
        requestDispatcher = getServletContext().getRequestDispatcher("/WEB-INF/jsp/show-review.jsp");
        req.setAttribute("listMovies", MovieDao.getInstance().findAllMovies());
